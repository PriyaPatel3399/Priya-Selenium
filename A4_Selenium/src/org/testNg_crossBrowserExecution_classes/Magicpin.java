...
public class Magicpin
{
	...
	@Test
	public void launchMagicpin(@Optional("chrome")  String browserName)//@Optional("chrome")--use to pass default value
	{                                                                                                                      //add it after creating TestNg xml class
		...
		driver.get("https://www.magicpin.in/");
		Reporter.log("Magicpin is launched");
		driver.quit();
	}
