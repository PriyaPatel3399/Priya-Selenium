...
public class ShariefBhai
{
	...
	@Test
	public void launchShariefBhai( @Optional("chrome") String browserName)//@Optional("chrome")--use to pass default value
	{                                                                                                                      //add it after creating TestNg xml class
		...
		driver.get("https://www.shariefbhai.com/");
		Reporter.log("ShariefBhai is launched");
		driver.quit();
	}
}
